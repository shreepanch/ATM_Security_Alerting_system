...
class MotionDetectorAdaptative():
    ...
    def initRecorder(self):  # Create the recorder
        ...
        self.writer = cv.CreateVideoWriter(datetime.now().strftime("%Y%m%d_%H%M%S") + ".wmv", codec, 8,
        ...
        while True:
            ...
            if not self.isRecording:
                ...
                if instant >= self.trigger_time + 10:  # Record during 10 seconds
                    ...
                    cv.PutText(currentframe, datetime.now().strftime("%Y.%m.%d %H:%M:%S"), (10, 30), self.timeFont,
